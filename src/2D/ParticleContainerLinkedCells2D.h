...
namespace twoD {
    ...
    class ParticleContainerLinkedCells2D : public ParticleContainer {
    private:
        /**
         * @brief the BoundaryConditionContainer which is used to calculate the boundary conditions for each domain side
         */
        std::unique_ptr<BoundaryConditionContainer2D> boundaryContainer;
         ...
         */
        static std::array<int, 8> getNeighbourIndices(int index);
    ...
    public:
        ...
        ParticleContainerLinkedCells2D();
         ...
         */
        ParticleContainerLinkedCells2D(double domainSizeX, double domainSizeY, double cutOffRadius,
                                       const std::array<int, 4> &boundaryConditionTypes = std::array<int, 4>{
                                               BoundaryCondition2D::REFLECTING_TYPE,
                                               BoundaryCondition2D::REFLECTING_TYPE,
                                               BoundaryCondition2D::REFLECTING_TYPE,
                                               BoundaryCondition2D::REFLECTING_TYPE});
